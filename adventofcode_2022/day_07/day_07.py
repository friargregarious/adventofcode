...
VERBOSE = "verbal" in sys.argv

# mostly controls which source we pull our instructions from
if TEST:
    data_file = "sample.txt"
else:
    data_file = "input.txt"

# verbose means we print more shit to the screen
verbose = False
if VERBOSE:
    verbose = True
...
if __name__ == "__main__":
    ...
    for index, command in enumerate(data):
        ...
        if command == "$ ls":
            continue  # we don't need to test for these lines yet
